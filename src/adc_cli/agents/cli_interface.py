...
from ..validation.contract_validator import ContractValidator, ContractValidationResult
...
class AgentCLIInterface:
    ...
    async def run_test_suite(
        ...
        total_execution_time = sum(test.duration_seconds for test in test_results) * 1000
    ...
    async def run_full_audit(self) -> Dict:
        ...
        try:
            ...
            health_score = health_report.health_score
            contract_score = contract_results.get("validation_summary", {}).get("compliance_score", 0.0)
