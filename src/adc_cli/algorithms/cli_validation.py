...
class CLICommandValidator:
    ...
    def validate_command(
        ...
        schema_validation = self._validate_schema(parsed_output["stdout"], expected_schema)
        ...
        overall_valid = (
            ...
            side_effects_validation["valid"] and
            performance_validation["valid"]
        )
    ...
    def _check_side_effects(self, validation_criteria: Dict) -> Dict:
        ...
        return {
            "valid": True,
            "checked": validation_criteria.get("side_effects", [])
        }
    
    def _measure_performance(self, execution_time_ms: float, validation_criteria: Dict) -> Dict:
        ...
        if execution_time_ms > max_execution_time:
            errors.append(f"Execution time {execution_time_ms:.2f}ms exceeds limit {max_execution_time}ms")
